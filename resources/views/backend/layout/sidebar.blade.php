...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="mt-3 pb-3 mb-3 text-center">
            <div class="">
                {{-- <img src="{{ asset('backend/dist/img/user2-160x160.jpg') }}" style="width: 40%; border-radius: 50px;"
                    alt="User Image"> --}}
                <img src="{{ asset('upload/images/users/' . Auth::user()->image) }}"style="width: 100px;height: 100px; border-radius: 50%;"
                    alt="User Image">
            </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="#"
                        class="nav-link {{ request()->routeIs('product.*', 'stockin*','stockout*') ? 'active' : '' }}">
